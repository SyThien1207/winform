...
namespace QuanLySieuThi
{
    ...
    public partial class frmTaiKhoan : Form
    {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {               
                    ...
                    string them1 = "insert into taikhoan Values ('" + uername + "','" + password + "','" + fullname + "','" + date + "','')";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update taikhoan set password ='" + password + "', fullname='"+fullname + "', isAdmin='" + 
        ...
        private void btn_ex_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                saveFileDialog.FileName = "TaiKhoanAdmin"; // Tùy chỉnh tên tệp mặc định

                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    string duongdan = saveFileDialog.FileName;
                    XuatExecl.exportecxel(dta1, duongdan, "");
